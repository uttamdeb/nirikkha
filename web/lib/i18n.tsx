...
const STRINGS = {
  ...
  settingsLede: {
    bn: "টেলিগ্রাম বট ও গ্রেডিং পছন্দ। মডেল কী সার্ভারের পরিবেশ থেকে আসে।",
    en: "Telegram bot and grading preferences. Model keys come from server environment.",
  },
  ...
  settingsTelegramLede: {
    bn: "BotFather টোকেন সংরক্ষণ করো, তারপর ওয়েবহুক যুক্ত করো।",
    en: "Save the BotFather token, then connect the webhook.",
  },
  settingsAiTitle: { bn: "২ · AI নোট", en: "2 · AI note" },
  settingsAiLede: {
    bn: "OCR ও grader provider সার্ভারের env থেকে চলে। এই স্ক্রিন শুধু অবস্থা দেখায়।",
    en: "OCR and grader providers run from server env. This screen only shows the state.",
  },
  settingsGradingTitle: { bn: "৩ · গ্রেডিং ও প্রকাশ", en: "3 · Grading and publish" },
  settingsGradingLede: {
    bn: "OCR threshold আর ডিফল্ট publish mode ঠিক করো।",
    en: "Set the OCR threshold and default publish mode.",
  },
